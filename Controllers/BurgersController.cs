...
namespace OrtizHansEjercicioPractico.Controllers
{
    public class BurgersController : Controller
    {
        private readonly HODbContext _context;

        public BurgersController(HODbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BurgerId,BurgerName,WithCheese,Price")] Burger burger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BurgerId,BurgerName,WithCheese,Price")] Burger burger)
        {
